...
# Fungsi untuk memuat semua data dari folder "data"
def load_knowledge():
    data_folder = "data"  # Pastikan folder "data" berada di direktori yang sama dengan main.py
    combined_text = ""
...
# Load data dan buat vector store
